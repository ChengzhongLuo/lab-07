...
# Setting up GPIO mode and pin for light sensor
light_channel = 0


# Setting up GPIO mode and pin for sound sensor
sound_channel = 1
...
threshold = 500  # set the threshold for light sensor (experiment to determine)
...
threshold = 200  # set the threshold for sound sensor (experiment to determine)
start_time = time.time()
while (time.time() - start_time) < 5:
